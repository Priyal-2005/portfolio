...
export const aiMlProjects = [
    {
        title: "CrisisGrid AI",
        contextNote: "Hackathon project built during a GenAI competition.",
    ...
    {
        title: "Talynx",
        contextNote: "Technical recruiting prototype built to automate resume parsing and indexing.",
    ...
    },
    {
        ...
        contextNote: "Personal AI experimentation project focused on RAG and conversational memory systems.",
