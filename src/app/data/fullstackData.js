...
export const fullstackProjects = [
    {
        title: "FreelanceFlow",
        contextNote: "End-to-end MERN stack SaaS application for client and billing management.",
    ...
    {
        title: "MediConnect",
        contextNote: "Full-stack medical clinic scheduling prototype designed for high UX speed.",
    ...
    {
        title: "FocusFlow",
        contextNote: "Productivity tool linking Pomodoro sequences with priority task layers.",
    ...
    },
    {
        ...
        contextNote: "Client-side financial utility demonstrating dynamic amortization charts.",
    ...
    },
    {
        ...
        contextNote: "Cloud-backed notebook application integrated with Firebase Realtime Database.",
    ...
    },
    {
        ...
        contextNote: "Full-featured photographer discoverability and booking web application.",
